...
@endsection
@section('title')
Les reçus de paiement en avance
@endsection
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-lg-center">
                        ...
                        <a href="{{ route('invoices.show',['id' => $payment->id]) }}" class="text-muted">{{ $payment->student->last_name }}</a>
                    </div>
                </div>

                <div class="col-lg-8">
                    <div>
                        <a href="{{ route('invoices.show',['id' => $payment->id]) }}" class="d-block text-primary text-decoration-underline mb-2">Facture #14251</a>
