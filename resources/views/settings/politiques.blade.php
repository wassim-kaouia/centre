...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Politique de confidentialité</h4>
            ...
            <div class="card-body">
                ...
                <form class="outer-repeater"  method="POST" action="{{ $policies != null && $policies->count() > 0 ? route('settings.edit_politique') :  route('settings.politique') }}" enctype="multipart/form-data" >
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-10">
                            <button type="submit" class="btn btn-primary">{{ $policies != null && $policies->count() > 0 ? 'Mise à Jour' : 'Créer La Page' }}</button>
